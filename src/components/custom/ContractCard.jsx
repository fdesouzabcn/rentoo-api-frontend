...
// ContractCard — shared component for rendering a contract.
//
// Props:
//   contract  object   — full contract object from the API
//   property  object   — the property this contract belongs to
